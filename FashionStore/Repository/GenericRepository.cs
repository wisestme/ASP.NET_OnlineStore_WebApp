...
namespace FashionStore.Repository
{
    public class GenericRepository<Tbl_Entity> : IRepository<Tbl_Entity> where Tbl_Entity : class
    {
        ...
        private CreamchicEntities _DBEntity;

        //create method for generic repository
        public GenericRepository(CreamchicEntities DBEntity)
        {
            _DBEntity = DBEntity;
